...
public interface ImageMapResourcesCache {
	...
	int getAreaId(Context context, Integer xmlResourceId, Integer dataId, Integer target);

	int getAreaId(Context context, Integer xmlResourceId, Integer dataId);
	
	ArrayList<Integer> getAreaGroups(Context context, Integer xmlResourceId, Integer dataId);
}
